...
<div class="main-profile">
    ...
    <div class="profile-content">
        ...
        <div class="profile-data">
            <tr>
                <td> Nome: <?php echo($result['nome']); ?> </td>
                <br>
                <td> CPF: <?php echo($result['cpf']); ?> </td>
                <br>
                <td> E-mail: <?php echo($result['email']); ?> </td>
                <br>
            ...
            <table class="tabela-extrato">
                ...
                function tableShow($result)
                {
                    while ($res = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                    <td>" . $data = implode("/",
                                    array_reverse(explode("-", $res['data_atualizacao']))) . "</td>
                                    <td>" . $res['saldo'] . "</td>
                                    <td>" . $res['saldo'] . "</td> 
                                </tr>";
                    }
